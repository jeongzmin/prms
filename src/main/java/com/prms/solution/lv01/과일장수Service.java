...
public class 과일장수Service {
	...
	*/
	public int 과일장수(int k, int m, int[] score) {
		
		int count = 0;
		int price = 0;
		
		Integer[] taget = Arrays.stream(score).boxed().toArray(Integer[]::new); 
		
		Arrays.sort(taget, Collections.reverseOrder());
